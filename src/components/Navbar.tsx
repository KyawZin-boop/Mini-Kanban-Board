            ...
            <div className="w-full max-w-sm min-w-[200px]">
                <div className="relative">
                    <input type="email" onChange={(e) => {
                        ...
                        className="w-full bg-transparent placeholder:text-gray-600 text-black text-sm border border-[#005E9A] rounded-md pl-3 pr-16 py-2 transition duration-300 ease focus:outline-none shadow-sm focus:shadow" placeholder="Type Todo to search..." />
                    <button
